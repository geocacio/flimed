...
module.exports = app => {
    ...
    app.route('/medico-resultado')
        .all(app.src.config.passport.authenticate())
        .get(doctor(app.src.api.role.doctor.viewDoctorResultado))

    app.route('/medico-pesquisa-avancada')
        .all(app.src.config.passport.authenticate())
        .get(doctor(app.src.api.role.doctor.viewDoctorPesquisaAvancada))

    app.route('/medico-marcar-consulta')
        .all(app.src.config.passport.authenticate())
        .get(doctor(app.src.api.role.doctor.viewDoctorMarcarConsulta))

    app.route('/medico-detalhes')
        .all(app.src.config.passport.authenticate())
        .get(doctor(app.src.api.role.doctor.viewDoctorDetalhes))
